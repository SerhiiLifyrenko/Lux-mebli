...
const videos = [
  { id: 1, src: "/3.MP4", title: "Сучасна кухня без ручок", desc: "Інтегрований профіль Gola та кам'яна стільниця" },
  { id: 2, src: "/4.MP4", title: "Кухня з кутовим островом", desc: "Максимально ергономічне планування простору" },
  { id: 3, src: "/2.MP4", title: "Мінімалізм у графітових тонах", desc: "Матові фасади з захистом від відбитків пальців" },
  { id: 4, src: "/1.MP4", title: "Преміум класика з порталом", desc: "Елегантне фрезерування та прихована витяжка" },
...
export default function VideoCarousel() {
  ...
  return (
    <section className="pt-6 md:pt-8 pb-12 md:pb-16 bg-[#111111] relative border-t border-white/5 overflow-hidden" id="video-reviews">
