...
const team = [
  {
    name: "Сергій",
    role: "Засновник",
    bio: "За 7 років особистого досвіду проконтролював запуск 300+ проєктів. Впровадив систему «подвійного контролю», де кожен виріб перевіряється технологом перед відвантаженням.",
  ...
  },
  {
    ...
    image: "/team_elena_realistic.png"
  },
  {
    name: "Сергій",
            ...
            <motion.div variants={itemVariants} key={idx} className="group relative overflow-hidden rounded-xl bg-[#111111] border border-white/5 hover:border-[#D4AF37]/50 transition-colors duration-500">
              <div className="aspect-[3/4] overflow-hidden">
                <img 
                  src={member.image} 
                  alt={member.name} 
                  className={`w-full h-full object-cover grayscale-0 opacity-100 scale-105 group-hover:grayscale group-hover:scale-100 group-hover:opacity-30 transition-all duration-700 ${member.objectPosition || 'object-center'}`}
                />
              </div>
              <div className="absolute inset-0 bg-gradient-to-t from-[#111111] via-[#111111]/85 to-transparent opacity-45 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-6">
